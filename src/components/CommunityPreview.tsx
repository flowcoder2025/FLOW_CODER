    ...
    <section id="community" className="py-16 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-6">최근 인기 포스트</h3>
          ...
          <div>
            <Card className="p-8 text-center bg-gradient-to-br from-primary/5 to-purple-500/5 border-primary/20">
              <CardContent className="p-0 space-y-6">
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">커뮤니티에 참여하세요</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 text-left">
                    ...
                    <div>
                      <div className="text-sm font-medium">실시간 채팅</div>
                  ...
                  <div className="flex items-center gap-3 text-left">
                    ...
                    <div>
                      <div className="text-sm font-medium">코딩 챌린지</div>
                  ...
                  <div className="flex items-center gap-3 text-left">
                    ...
                    <div>
                      <div className="text-sm font-medium">멘토링</div>
