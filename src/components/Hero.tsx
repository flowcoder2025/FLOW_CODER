        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1653564142048-d5af2cf9b50f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2RpbmclMjBwcm9ncmFtbWluZyUyMHdvcmtzcGFjZXxlbnwxfHx8fDE3NTkwOTUwMjJ8MA&ixlib=rb-4.1.0&q=80&w=1080"
                alt="코딩 워크스페이스"
                width={1080}
                height={720}
            ...
            <div className="absolute -top-4 -right-4 bg-background p-4 rounded-xl shadow-lg border">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">실시간 협업</span>
              </div>
            </div>
            ...
            <div className="absolute -bottom-4 -left-4 bg-background p-4 rounded-xl shadow-lg border">
              ...
              <div className="text-xl font-bold">1,234명</div>
            </div>
          </div>
        </div>
      </div>
